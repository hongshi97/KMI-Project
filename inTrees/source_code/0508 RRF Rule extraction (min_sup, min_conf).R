...
freqPattern <- getFreqPattern(ruleMetric, minsup = 0.0024, minconf = 0.6, minlen = 1, maxlen = 8) 
...
write.csv(pred1_rules, "0508_misup0.24%,minconf60%_no_prune.csv")
...
freqPattern_prune <- getFreqPattern(temp_rule, minsup = 0.0024, minconf = 0.6, minlen = 1, maxlen = 8) 
